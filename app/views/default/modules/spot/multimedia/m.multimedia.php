...
$oMulti->ValidaNivelUsuario("spot_multimedia");
...
function Editar(id) {
    ...
    $.ajax({
        data: jsonDatos,
        type: "post",
        url: "app/views/default/modules/spot/multimedia/m.multimedia.form.php",
        beforeSend: function() {
            $("#divFormulario").html(
...
function Borrar(id) {
    if (confirm("Esta seguro de borrar la información del spot? Esta acción no se podra deshacer") === false)
        return;
...
function Listado() {
    var jsonDatos = {
        "cli_id": $("#cli_id_1 option:selected").val(),
        "cli_activo": $("#cli_activo_1 option:selected").val(),
    };
    $.ajax({
        data: jsonDatos,
        type: "post",
        url: "app/views/default/modules/spot/multimedia/m.multimedia.listado.php",
        beforeSend: function() {
    ...
    <center>
        <form id="frmOpciones" name="frmOpciones" method="post" class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select id="cli_id_1" name="cli_id_1" class="form-control" <?php
            ...
            <div class="form-group" style="float:rigth;">
                ...
                <input type="button" class="btn btn-primary" id="btnAgregar" name="btnAgregar"
                    value="Agregar contenido multimedia">
            </div>
        </form>
        <center>
            <hr>
            <!-- Modal -->
            <div class="modal fullscreen-modal fade" id="myModal_1" tabindex="-1" role="dialog"
                aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Multimedia Spot</h4>
                        </div>
